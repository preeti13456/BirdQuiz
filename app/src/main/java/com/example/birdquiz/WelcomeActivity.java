...
public class WelcomeActivity extends AppCompatActivity
        implements
        com.example.birdquiz.QuestionNumberPickerDialogFragment.QuestionNumberPickedListener, Activity {
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.begin_quiz_button) {
    ...
    private void onBeginQuizButtonClicked() {
        ...
        com.example.birdquiz.QuestionNumberPickerDialogFragment questionNumberPickerDialogFragment = com.example.birdquiz.QuestionNumberPickerDialogFragment.newInstance(1, mTotalNumberOfQuestions);
